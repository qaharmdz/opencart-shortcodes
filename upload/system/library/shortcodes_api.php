...
class ShortcodesAPI {
   ...
   public function do_shortcode($content) {
      ...
      return preg_replace_callback('/' . $pattern . '/s', 'ShortcodesAPI::do_shortcode_tag', $content);
   }
   ...
   public function strip_shortcodes($content) {
      ...
      return preg_replace_callback('/' . $pattern . '/s', 'ShortcodesAPI::strip_shortcode_tag', $content);
   }
